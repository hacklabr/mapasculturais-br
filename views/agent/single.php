            ...
            <?php if ( $this->isEditable() || ($entity->publicLocation && $lat && $lng) ): ?>
                <div class="servico clearfix">
                    ...
                    <div class="infos">
                        ...
                        <p><span class="label">CEP:</span> <span class="js-editable" data-edit="En_CEP" data-original-title="CEP" data-emptytext="Insira o CEP" data-showButtons="bottom"><?php echo $entity->En_CEP ?></span></p>
                        <p><span class="label">Logradouro:</span> <span class="js-editable" data-edit="En_Nome_Logradouro" data-original-title="Logradouro" data-emptytext="Insira o logradouro" data-showButtons="bottom"><?php echo $entity->En_Nome_Logradouro ?></span></p>
                        <p><span class="label">Número:</span> <span class="js-editable" data-edit="En_Num" data-original-title="Número" data-emptytext="Insira o Número" data-showButtons="bottom"><?php echo $entity->En_Num ?></span></p>
                        <p><span class="label">Complemento:</span> <span class="js-editable" data-edit="En_Complemento" data-original-title="Complemento" data-emptytext="Insira um complemento" data-showButtons="bottom"><?php echo $entity->En_Complemento ?></span></p>
                        <p><span class="label">Bairro:</span> <span class="js-editable" data-edit="En_Bairro" data-original-title="Bairro" data-emptytext="Insira o Bairro" data-showButtons="bottom"><?php echo $entity->En_Bairro ?></span></p>
                        <p><span class="label">Município:</span> <span class="js-editable" data-edit="En_Municipio" data-original-title="Município" data-emptytext="Insira o Município" data-showButtons="bottom"><?php echo $entity->En_Municipio ?></span></p>
                        <p><span class="label">Estado:</span> <span class="js-editable" data-edit="En_Estado" data-original-title="Estado" data-emptytext="Insira o Estado" data-showButtons="bottom"><?php echo $entity->En_Estado ?></span></p>
